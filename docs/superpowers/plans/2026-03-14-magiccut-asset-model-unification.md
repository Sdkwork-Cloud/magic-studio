...
**Goal:** Make `@sdkwork/magic-studio-magiccut` use asset-center managed assets as the canonical source of truth, with timeline resources reduced to derived render/editor views.
...
**Files:**
- Create: `packages/sdkwork-magic-studio-magiccut/tests/magicCutAssetState.test.ts`
- Create: `packages/sdkwork-magic-studio-magiccut/src/domain/assets/magicCutAssetState.ts`
- Modify: `packages/sdkwork-magic-studio-magiccut/src/store/types.ts`
...
Run: `pnpm --filter @sdkwork/magic-studio-magiccut test tests/magicCutAssetState.test.ts`
...
**Files:**
- Modify: `packages/sdkwork-magic-studio-magiccut/src/store/types.ts`
- Modify: `packages/sdkwork-magic-studio-magiccut/src/utils/assetReferenceNormalization.ts`
...
- Modify: `packages/sdkwork-magic-studio-magiccut/src/components/Timeline/MagicCutTimelineToolbar.tsx`
- Modify: `packages/sdkwork-magic-studio-assets/src/services/assetBusinessService.ts`
...
Run:
- `pnpm --filter @sdkwork/magic-studio-magiccut test tests/magicCutAssetState.test.ts`

- [ ] **Step 3: Implement the import flow**

Change MagicCut import helpers so they:
- upload/import with `@sdkwork/magic-studio-assets`
...
**Files:**
- Modify: `packages/sdkwork-magic-studio-magiccut/src/store/magicCutStore.tsx`
- Modify: `packages/sdkwork-magic-studio-magiccut/src/services/templateService.ts`
...
Run:
- `pnpm --filter @sdkwork/magic-studio-magiccut test tests/magicCutAssetState.test.ts`
- `pnpm --filter @sdkwork/magic-studio-magiccut test tests/importDropSequence.test.ts`
...
- Modify: `packages/sdkwork-magic-studio-magiccut/src/engine/AudioEngine.ts`
- Modify: `packages/sdkwork-magic-studio-magiccut/src/engine/renderer/TimelineRenderer.ts`
- Modify: `packages/sdkwork-magic-studio-magiccut/src/components/Player/MagicCutPlayer.tsx`
- Modify: `packages/sdkwork-magic-studio-magiccut/src/components/Timeline/*` as needed
...
Run:
- `pnpm --filter @sdkwork/magic-studio-magiccut test tests/playerPreviewService.test.ts`
- `pnpm --filter @sdkwork/magic-studio-magiccut test tests/transitionPlayback.test.ts`
- `pnpm --filter @sdkwork/magic-studio-magiccut test tests/exportValidation.test.ts`
