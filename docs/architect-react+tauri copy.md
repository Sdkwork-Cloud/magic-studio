...
| 技术 | 版本 | 用途 | 说明 |
|------|------|------|------|
| **React** | 19.2.x | UI 框架 | 最新版本，支持并发特性 |
| **TypeScript** | 5.9.x | 类型系统 | 严格模式，完整类型支持 |
| **Vite** | 7.3.x | 构建工具 | 极速开发体验，ESM 原生支持 |
| **Zustand** | 5.0.x | 状态管理 | 轻量级，支持中间件 |
| **Tailwind CSS** | 4.2.x | 样式方案 | 原子化 CSS，JIT 编译 |

### 2.2 桌面应用技术栈

| 技术 | 版本 | 用途 | 说明 |
|------|------|------|------|
| **Tauri** | 2.10.x | 桌面应用框架 | Rust 后端，极小体积 |
| **Tauri Plugins** | 2.x | 系统能力扩展 | 文件系统、对话框、通知等 |
...
| 技术 | 版本 | 用途 | 说明 |
|------|------|------|------|
| **Monaco Editor** | 4.7.x | 代码编辑器 | VS Code 同款编辑器 |
| **TipTap** | 3.20.x | 富文本编辑器 | 可扩展，ProseMirror 内核 |
| **xterm.js** | 6.0.x | 终端模拟器 | 完整终端功能支持 |

### 2.4 云服务技术栈

| 技术 | 版本 | 用途 | 说明 |
|------|------|------|------|
| **AWS SDK S3** | 3.994.x | 对象存储 | 文件上传、下载、预签名 |
| **Google GenAI** | 1.42.x | AI 服务 | Gemini API 集成 |

### 2.5 工具库

| 技术 | 版本 | 用途 | 说明 |
|------|------|------|------|
| **Lucide React** | 0.575.x | 图标库 | 1000+ 精美图标 |
| **classnames** | 2.5.x | 类名拼接 | 条件类名处理 |
| **immer** | 11.1.x | 不可变数据 | 简化状态更新 |
| **JSZip** | 3.10.x | ZIP 处理 | 文件压缩解压 |
| **markdown-it** | 14.1.x | Markdown 解析 | 高性能解析器 |
| **mediabunny** | 1.34.x | 媒体处理 | 音视频处理工具 |
