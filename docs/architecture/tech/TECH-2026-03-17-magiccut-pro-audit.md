> Migrated from `docs/plans/2026-03-17-magiccut-pro-audit.md` on 2026-06-24.
...
**Goal:** Fix the highest-leverage workflow, performance, and captioning issues in `@sdkwork/magic-studio-magiccut` while documenting the remaining benchmark gaps for later feature work.
...
**Files:**
- Modify: `packages/sdkwork-magic-studio-magiccut/src/hooks/useShortcuts.ts`
- Modify: `packages/sdkwork-magic-studio-magiccut/tests/shortcutDefinitions.test.ts`
...
Run: `pnpm --filter @sdkwork/magic-studio-magiccut test -- tests/shortcutDefinitions.test.ts`
...
- Create: `packages/sdkwork-magic-studio-magiccut/src/domain/assets/resourcePanelAssets.ts`
- Create: `packages/sdkwork-magic-studio-magiccut/tests/resourcePanelAssets.test.ts`
...
Run: `pnpm --filter @sdkwork/magic-studio-magiccut test -- tests/resourcePanelAssets.test.ts`
...
**Files:**
- Modify: `packages/sdkwork-magic-studio-magiccut/src/components/Resources/SkimmableAssetCard.tsx`
- Modify: `packages/sdkwork-magic-studio-magiccut/src/services/TrackFactory.ts`
- Modify: `packages/sdkwork-magic-studio-magiccut/src/components/Timeline/MagicCutTimeline.tsx`
- Modify: `packages/sdkwork-magic-studio-magiccut/src/components/Timeline/MagicCutTrackHeader.tsx`
- Modify: `packages/sdkwork-magic-studio-magiccut/src/components/Timeline/TimelineMinimap.tsx`
- Create: `packages/sdkwork-magic-studio-magiccut/tests/trackFactory.test.ts`
- Create: `packages/sdkwork-magic-studio-magiccut/tests/skimmableAssetCard.test.tsx`
...
Run: `pnpm --filter @sdkwork/magic-studio-magiccut test -- tests/trackFactory.test.ts tests/skimmableAssetCard.test.tsx`
