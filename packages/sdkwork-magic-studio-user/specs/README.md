# SDKWork Magic Studio User Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-user`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-user` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-user` |
| Domain | `iam` |
| Capability | `user` |
...
- `pnpm --filter @sdkwork/magic-studio-user typecheck`
