# SDKWork Magic Studio Plugins Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-plugins`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-plugins` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-plugins` |
| Domain | `platform` |
| Capability | `plugin` |
...
- `pnpm --filter @sdkwork/magic-studio-plugins typecheck`
