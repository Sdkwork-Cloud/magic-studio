...
```typescript
import { assetServiceRegistry, initializeAssetServices } from '@sdkwork/magic-studio-assets';
...
```typescript
import { assetService, AssetType } from '@sdkwork/magic-studio-assets';
...
```typescript
import { useAssetUrl } from '@sdkwork/magic-studio-assets';
...
```typescript
import { ChooseAsset, AssetType } from '@sdkwork/magic-studio-assets';
...
1. Update imports from `'../../services/assets/AssetTypes'` to `'@sdkwork/magic-studio-assets'`
