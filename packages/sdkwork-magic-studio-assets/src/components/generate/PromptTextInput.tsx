...
const EDITOR_STYLES = `
.sdk-prompt-text-input .ProseMirror {
    outline: none;
    color: #e4e4e7;
    min-height: 100%;
...
.sdk-prompt-text-input .ProseMirror p {
    line-height: 1.6;
}
.sdk-prompt-text-input .ProseMirror p.is-editor-empty:first-child::before {
...
.sdk-prompt-text-input .mention-chip {
...
.sdk-prompt-text-input .mention-chip:hover {
    background-color: rgba(59, 130, 246, 0.25);
}

/* --- Custom Scrollbar (Stealth Mode) --- */
.sdk-prompt-text-input .prompt-editor-scroll-container {
    scrollbar-width: thin;
    scrollbar-color: transparent transparent;
}
.sdk-prompt-text-input .prompt-editor-scroll-container:hover {
    scrollbar-color: rgba(255, 255, 255, 0.2) transparent;
}

.sdk-prompt-text-input .prompt-editor-scroll-container::-webkit-scrollbar {
    width: 6px;
    height: 6px;
}
.sdk-prompt-text-input .prompt-editor-scroll-container::-webkit-scrollbar-track {
    background: transparent;
}
.sdk-prompt-text-input .prompt-editor-scroll-container::-webkit-scrollbar-thumb {
    background-color: transparent;
    border-radius: 3px;
    border: 2px solid transparent; /* padding around thumb */
    background-clip: content-box;
}
.sdk-prompt-text-input .prompt-editor-scroll-container:hover::-webkit-scrollbar-thumb {
    background-color: rgba(255, 255, 255, 0.2);
}
.sdk-prompt-text-input .prompt-editor-scroll-container::-webkit-scrollbar-thumb:hover {
    background-color: rgba(255, 255, 255, 0.4);
}
.sdk-prompt-text-input .prompt-editor-scroll-container::-webkit-scrollbar-corner {
    background: transparent;
}
`;
...
export const PromptTextInput: React.FC<PromptTextInputProps> = ({
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: `prompt-editor sdk-prompt-text-input__editor w-full h-full`,
                style: editorAttributesStyle,
            },
    ...
    const handleCopy = () => {
        if (!editor) return;
        void runtime.clipboard.copy(editor.getText());
        setCopied(true);
    ...
    return (
        <div className={`sdk-prompt-text-input flex flex-col gap-2 ${className}`} data-prompt-text-input="">
