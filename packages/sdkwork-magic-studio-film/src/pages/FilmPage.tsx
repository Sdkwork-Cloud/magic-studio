...
import type { FilmViewMode } from '@sdkwork/magic-studio-types/film';
import { useTranslation, createLocalizedText, resolveLocalizedText } from '@sdkwork/magic-studio-i18n';
import type { LocalizedText } from '@sdkwork/magic-studio-i18n';
