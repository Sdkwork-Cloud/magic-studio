# SDKWork Magic Studio Film Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-film`.
...
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-film` |
| Domain | `platform` |
