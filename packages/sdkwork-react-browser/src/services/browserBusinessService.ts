...
export const setBrowserBusinessAdapter = controller.setAdapter;
export const getBrowserBusinessAdapter = controller.getAdapter;
export const resetBrowserBusinessAdapter = controller.resetAdapter;
