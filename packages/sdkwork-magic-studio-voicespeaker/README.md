...
This README is the SDKWork module entrypoint for `@sdkwork/magic-studio-voicespeaker`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `pnpm --filter @sdkwork/magic-studio-voicespeaker typecheck`
