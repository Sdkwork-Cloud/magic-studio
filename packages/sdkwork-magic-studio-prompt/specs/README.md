# SDKWork Magic Studio Prompt Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-prompt`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-prompt` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-prompt` |
| Domain | `intelligence` |
| Capability | `prompt` |
...
- `pnpm --filter @sdkwork/magic-studio-prompt typecheck`
