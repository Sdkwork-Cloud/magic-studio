# SDKWork Magic Studio Vip Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-vip`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-vip` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-vip` |
| Domain | `commerce` |
| Capability | `vip` |
