# SDKWork Magic Studio Image Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-image`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-image` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-image` |
...
- `pnpm --filter @sdkwork/magic-studio-image typecheck`
