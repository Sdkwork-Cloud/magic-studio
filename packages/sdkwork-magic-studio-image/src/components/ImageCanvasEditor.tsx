...
interface ImageCanvasEditorProps {
    ...
    onAIEdit: (request: ImageEditRequest) => Promise<GeneratedImageResult | null>;
}

export const ImageCanvasEditor: React.FC<ImageCanvasEditorProps> = ({ image, onSave, onAIEdit }) => {
    // --- Hook Resolution ---
        ...
        <div className="flex flex-col h-full bg-[#111] overflow-hidden select-none">
            ...
            <div className="h-14 bg-[#1e1e1e] border-b border-[#333] flex items-center justify-between px-4 z-20 shrink-0">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button onClick={handleSave} disabled={!imgObj || isProcessing} className="bg-blue-600 hover:bg-blue-500 border-0">
