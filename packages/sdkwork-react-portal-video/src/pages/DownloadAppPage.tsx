...
const PC_DOWNLOADS: DownloadOption[] = [
    {
        ...
        title: 'Windows �?,
        description: '适用�?Windows 10/11 64位系�?,
        version: 'v2.0.0',
        size: '156 MB',
        requirements: 'Windows 10 或更高版�?,
    ...
    },
    {
        ...
        icon: <Apple size={32} />,
        title: 'macOS �?,
        description: '适用�?macOS 12.0 及以上版�?,
        version: 'v2.0.0',
        size: '178 MB',
    ...
    },
    {
        ...
        title: 'Linux �?,
        description: '适用�?Ubuntu 20.04+ / Debian 11+',
        version: 'v2.0.0',
        size: '162 MB',
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                        ...
                        <div className="relative z-10 max-w-6xl mx-auto px-8 py-16">
                            <div className="text-center mb-12">
                                ...
                                <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                                    {t('download.subtitle', '选择适合您设备的版本，开�?AI 创作之旅')}
                                </p>
                            </div>
                        ...
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-white">
                                    {t('download.pc_title', '桌面端下�?)}
                                </h2>
                                <p className="text-sm text-gray-500">
                                    {t('download.pc_subtitle', '功能完整，体验最�?)}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="max-w-6xl mx-auto px-8 py-12 border-t border-white/5">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-white">
                                    {t('download.mobile_title', '移动端下�?)}
                                </h2>
                                <p className="text-sm text-gray-500">
                                    {t('download.mobile_subtitle', '随时随地，创意无�?)}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="max-w-6xl mx-auto px-8 py-12 border-t border-white/5">
                        <div className="text-center text-sm text-gray-500">
                            <p className="mb-2">
                                {t('download.version_note', '所有版本均支持云端同步，数据互�?)}
                            </p>
                            <p>
