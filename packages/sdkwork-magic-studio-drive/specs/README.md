# SDKWork Magic Studio Drive Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-drive`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-drive` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-drive` |
| Domain | `content` |
| Capability | `drive` |
...
- `pnpm --filter @sdkwork/magic-studio-drive typecheck`
