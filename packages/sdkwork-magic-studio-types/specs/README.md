# SDKWork Magic Studio Types Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-types`.
...
| Type | `node-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-types` |
| Domain | `platform` |
