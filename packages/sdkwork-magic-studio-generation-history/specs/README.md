# SDKWork Magic Studio Generation History Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-generation-history`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-generation-history` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-generation-history` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/magic-studio-generation-history typecheck`
