# SDKWork Magic Studio Sfx Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-sfx`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-sfx` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-sfx` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/magic-studio-sfx typecheck`
