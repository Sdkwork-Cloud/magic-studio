# SDKWork Magic Studio Skills Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-skills`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-skills` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-skills` |
| Domain | `intelligence` |
| Capability | `skill` |
