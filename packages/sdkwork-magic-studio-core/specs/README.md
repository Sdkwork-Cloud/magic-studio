# SDKWork Magic Studio Core Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-core`.
...
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-core` |
| Domain | `platform` |
