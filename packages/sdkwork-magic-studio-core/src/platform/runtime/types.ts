import type { SdkworkRuntimeKind } from '@sdkwork/magic-studio-types/runtime';
import type {
  AppMetadata,
  BrowserInstance,
  BrowserOptions,
...
export type PlatformRuntimeKind = SdkworkRuntimeKind;
...
export interface PlatformBridgeCapability {
  available(): boolean;
  invoke<T = unknown>(
