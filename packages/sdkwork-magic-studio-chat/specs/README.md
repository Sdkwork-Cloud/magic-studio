# SDKWork Magic Studio Chat Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-chat`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-chat` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-chat` |
...
- `pnpm --filter @sdkwork/magic-studio-chat typecheck`
