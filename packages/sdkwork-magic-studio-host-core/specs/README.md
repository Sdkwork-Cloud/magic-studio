# SDKWork Magic Studio Host Core Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-host-core`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-host-core` |
| Type | `node-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-host-core` |
| Domain | `device` |
...
- `pnpm --filter @sdkwork/magic-studio-host-core typecheck`
