# SDKWork Magic Studio Distribution Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-distribution`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-distribution` |
| Type | `node-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-distribution` |
| Domain | `device` |
...
- `pnpm --filter @sdkwork/magic-studio-distribution typecheck`
