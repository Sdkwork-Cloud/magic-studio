...
import type { StorageConfig, StorageProviderType, MaterialStorageConfig } from '../entities'
import { Button } from '@sdkwork/magic-studio-commons'
import { storageManager, S3Provider } from '@sdkwork/magic-studio-core/services'
...
const StorageSettings: React.FC = () => {
    ...
    const updateStorage = async (id: string, updates: Partial<StorageConfig>) => {
        ...
        const newStorageMap = { ...settings.storage };
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-[9px] px-1 rounded border border-gray-500/30 text-gray-500">
                                                        OBJECT STORAGE
                                                    </span>
                                                </div>
                                            </div>
