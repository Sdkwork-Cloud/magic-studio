...
const MediaSettings: React.FC = () => {
    ...
    const getPlatformIcon = (type: MediaPlatformType) => {
        switch (type) {
            // Global
            case 'twitter': return <span className="text-[10px] font-bold bg-black text-white px-1 rounded">X</span>;
            case 'facebook': return <span className="text-[10px] font-bold bg-[#1877F2] text-white px-1 rounded">f</span>;
            case 'instagram': return <span className="text-[10px] font-bold bg-[#E4405F] text-white px-1 rounded">IG</span>;
            case 'linkedin': return <span className="text-[10px] font-bold bg-[#0A66C2] text-white px-1 rounded">in</span>;
            case 'youtube': return <span className="text-[10px] font-bold bg-[#FF0000] text-white px-1 rounded">YT</span>;
