...
export const SettingPathInput: React.FC<PathInputProps> = (props) => {
    ...
    const isDesktop = isDesktopShellRuntimeKind(runtime.system.kind());
    ...
    const handleBrowse = async () => {
        ...
        try {
            if (props.type === 'folder') {
                result = await runtime.fileSystem.selectDir();
            } else {
                const files = await runtime.fileSystem.selectFile({ multiple: false });
    ...
    const handleCopy = () => {
        ...
        void runtime.clipboard.copy(props.value);
        setIsCopied(true);
