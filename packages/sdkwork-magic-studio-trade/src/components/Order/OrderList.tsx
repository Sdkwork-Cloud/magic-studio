...
import { Button, cn } from '@sdkwork/magic-studio-commons';
...
export const OrderList: React.FC<OrderListProps> = ({
  ...
  const statusOptions: FilterOption[] = [
    ...
    { value: 'REFUNDING', label: orderStatusLabel('REFUNDING' as OrderStatus) },
    { value: 'REFUNDED', label: orderStatusLabel('REFUNDED' as OrderStatus) },
  ];

  const typeOptions: FilterOption[] = [
    { value: '', label: t('market.order.filters.all_types', 'All Types') },
    { value: 'GOODS', label: orderTypeLabel('GOODS' as OrderType) },
    { value: 'VIRTUAL', label: orderTypeLabel('VIRTUAL' as OrderType) },
    { value: 'MEMBER', label: orderTypeLabel('MEMBER' as OrderType) },
    { value: 'POINTS', label: orderTypeLabel('POINTS' as OrderType) },
    { value: 'IM_GROUP', label: orderTypeLabel('IM_GROUP' as OrderType) },
    { value: 'BOOKING', label: orderTypeLabel('BOOKING' as OrderType) },
    { value: 'SERVICE', label: orderTypeLabel('SERVICE' as OrderType) },
  ];
