...
pub async fn read_render_capabilities(
    ...
    Json<
        crate::response::ApiEnvelope<crate::services::magiccut_render::MagicCutRenderCapabilities>,
    >,
> {
...
) -> ServerResult<Json<crate::response::ApiListEnvelope<serde_json::Value>>> {
...
pub async fn list_renders(
    ...
    Json<
        crate::response::ApiListEnvelope<crate::services::magiccut_render::MagicCutRenderJobRecord>,
    >,
> {
...
pub async fn create_render(
    ...
    Json<crate::response::ApiEnvelope<crate::services::magiccut_render::MagicCutRenderJobRecord>>,
> {
    Ok(success(
        state
