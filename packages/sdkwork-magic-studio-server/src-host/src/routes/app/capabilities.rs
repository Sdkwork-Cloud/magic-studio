...
pub async fn read_capability_summary(
    ...
    Json<crate::response::ApiEnvelope<crate::services::capabilities::AppCapabilitySummaryRecord>>,
> {
...
pub async fn list_capability_domains(
    ...
    Json<
        crate::response::ApiListEnvelope<crate::services::capabilities::AppCapabilityDomainRecord>,
    >,
> {
