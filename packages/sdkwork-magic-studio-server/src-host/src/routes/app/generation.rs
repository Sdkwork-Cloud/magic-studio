...
) -> ServerResult<Json<crate::response::ApiListEnvelope<crate::services::voices::VoiceSpeakerRecord>>>
{
...
pub async fn list_generation_tasks(
    ...
    Json<crate::response::ApiListEnvelope<crate::services::generation::GenerationTaskRecord>>,
> {
...
pub async fn read_generation_task(
    ...
    Json<crate::response::ApiEnvelope<crate::services::generation::GenerationTaskRecord>>,
> {
    Ok(success(
...
pub async fn list_sfx_categories(
    State(state): State<AppState>,
) -> ServerResult<Json<crate::response::ApiListEnvelope<SfxCategoryRecord>>> {
...
pub async fn optimize_prompt(
    ...
    Json<crate::response::ApiEnvelope<crate::services::generation::PromptOptimizeResultRecord>>,
> {
