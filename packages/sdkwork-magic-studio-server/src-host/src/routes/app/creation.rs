...
pub async fn read_creation_capabilities(
    ...
    Json<crate::response::ApiEnvelope<crate::services::creation::CreationCapabilitiesRecord>>,
> {
...
pub async fn create_creation_session(
    ...
    Json<crate::response::ApiEnvelope<crate::services::creation::CreationSessionRecord>>,
> {
...
pub async fn list_creation_presets(
    ...
    Json<crate::response::ApiListEnvelope<crate::services::creation_presets::CreationPresetRecord>>,
> {
...
pub async fn list_creation_batches(
    ...
    Json<crate::response::ApiListEnvelope<crate::services::creation_batches::CreationBatchRecord>>,
> {
...
pub async fn create_creation_batch(
    ...
    Json<crate::response::ApiEnvelope<crate::services::creation_batches::CreationBatchRecord>>,
> {
...
pub async fn create_creation_preset(
    ...
    Json<crate::response::ApiEnvelope<crate::services::creation_presets::CreationPresetRecord>>,
> {
    Ok(success(
...
pub async fn create_creation_template(
    ...
    Json<crate::response::ApiEnvelope<crate::services::creation_templates::CreationTemplateRecord>>,
> {
    Ok(success(
...
pub async fn read_current_creation_session(
    ...
    Json<crate::response::ApiEnvelope<crate::services::creation::CreationSessionSnapshotRecord>>,
> {
...
pub async fn read_creation_history_entry(
    ...
    Json<
        crate::response::ApiEnvelope<crate::services::creation_history::CreationHistoryEntryRecord>,
    >,
> {
    Ok(success(
        state
