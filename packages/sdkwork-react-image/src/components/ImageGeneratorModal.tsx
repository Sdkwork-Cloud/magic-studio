...
const ImageGeneratorContent: React.FC<ImageGeneratorModalProps> = ({ onClose, onSuccess, actionLabel = "Add to Timeline" }) => {
    ...
    return (
        <div className="flex h-full overflow-hidden relative">
            <div className="w-[420px] flex-none h-full border-r border-[#333] z-10 bg-[#09090b] flex flex-col">
                <ImageLeftGeneratorPanel onClose={onClose} />
            </div>
