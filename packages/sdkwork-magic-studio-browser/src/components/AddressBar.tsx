...
export const AddressBar: React.FC = () => {
    ...
    const resolvedActiveUrl = activeTab?.url ?? 'about:blank';
    const resolvedActiveInput = resolvedActiveUrl === 'about:blank' ? '' : resolvedActiveUrl;
    const [inputState, setInputState] = useState(() => ({
        tabId: resolvedActiveTabId,
        url: resolvedActiveUrl,
        value: resolvedActiveInput,
    }));
    ...
    const input =
        inputState.tabId === resolvedActiveTabId && inputState.url === resolvedActiveUrl
            ? inputState.value
            : resolvedActiveInput;
    ...
    const handleExternalOpen = () => {
        if (activeTab && activeTab.url !== 'about:blank') {
            void runtime.shell.openExternal(activeTab.url);
        }
    };
