import { i18nService, normalizeLocale } from './I18nService.ts';
import type { LocaleInput } from './types.ts';
...
export type CurrencyFormatterOptions = NumberFormatterOptions;
