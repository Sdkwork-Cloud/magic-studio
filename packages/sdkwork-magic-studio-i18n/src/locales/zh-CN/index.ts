import { common, sidebar, header, download } from './common.ts';
...
import { drive, studio, portal } from './modules.ts';
import { canvas } from './canvas.ts';
import { magicCut } from './magicCut.ts';
import { film } from './film.ts';
import { video } from './video.ts';
import { image } from './image.ts';
import { portalVideo } from './portalVideo.ts';
import { assetCenter } from './assetCenter.ts';
