# SDKWork Magic Studio I18n Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-i18n`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-i18n` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-i18n` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/magic-studio-i18n typecheck`
