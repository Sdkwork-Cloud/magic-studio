# SDKWork Magic Studio Commons Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-commons`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-commons` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-commons` |
| Domain | `platform` |
