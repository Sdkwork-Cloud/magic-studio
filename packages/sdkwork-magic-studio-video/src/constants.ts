...
import { VIDEO_STYLES } from '@sdkwork/magic-studio-commons/constants'
...
export const VIDEO_MODELS: VideoModelEntry[] = [
    ...
    },
    {
        ...
        badge: 'WAN',
        maxAssetsCount: 1,
        supportedModes: ['smart_reference', 'subject_ref', 'image-to-video'],
        capabilities: {
            maxDuration: 10,
            resolutions: ['720p', '1080p'],
            ratios: ['16:9', '9:16', '1:1', '3:4', '4:3', '21:9'],
    ...
    },
    {
        ...
        badge: 'MASTER',
        maxAssetsCount: 4,
        supportedModes: ['smart_reference', 'subject_ref', 'start_end', 'lip-sync', 'video-to-video', 'extend'],
        capabilities: {
            maxDuration: 10,
            resolutions: ['720p', '1080p'],
...
export const VIDEO_PROVIDER_API_PROFILES: Record<VideoApiProviderId, VideoProviderApiProfile> = {
    ...
    kling: {
        ...
        modeSpecs: [
            ...
            { mode: 'extend', supported: true, requiredAssets: ['video'], durationRangeSeconds: [5, 10] }
        ]
    },
    google: {
        provider: 'google',
...
export const VIDEO_MORE_GENERATION_TOOLS: Array<{
    ...
    },
    {
        id: 'extend',
        label: 'Extend',
        description: 'Continue an uploaded video with additional generated motion.',
        icon: ArrowRightLeft,
        badge: 'CONTINUE'
    },
];
