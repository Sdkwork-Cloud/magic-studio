...
import { resolveGeneratedVideoResultUrl, type VideoTask } from '../entities';
...
export const VideoGenerationItem: React.FC<VideoGenerationItemProps> = ({ task, onDelete, onReuse }) => {
    ...
    const videoUrl = resolveGeneratedVideoResultUrl(task.results?.[0]);
    ...
    const handleDownload = () => {
        ...
        a.href = videoUrl;
        a.download = `video-${resolveEntityKey(task)}.mp4`;
        a.click();
    };
