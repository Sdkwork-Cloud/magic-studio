...
import { StyleSelector, type InputAttachment } from '@sdkwork/magic-studio-assets/creation-chat';
...
interface VideoPromptStyleSectionProps {
    ...
    enhanceUnavailableReason?: string | null;
    ...
    onAudioTrackChange: (asset: Asset | null) => void;
...
export const VideoPromptStyleSection: React.FC<VideoPromptStyleSectionProps> = ({
    ...
    const resolvedEnhanceUnavailableReason = !enhanceEnabled
        ? enhanceUnavailableReason
        : null;
        ...
        <>
            <div className="space-y-2">
                ...
                <PromptTextInput
                    ...
                    className="bg-[#121214]"
                    assets={attachments}
                    onEnhance={enhanceEnabled ? onEnhance : undefined}
                    enableEnhance={enhanceEnabled}
                />
                {resolvedEnhanceUnavailableReason && (
            ...
            <div className="space-y-2">
                ...
                {showAdvanced && (
                    <div className="animate-in fade-in slide-in-from-top-1 space-y-4 pt-1 pb-2">
                        ...
                        <ChooseAsset
                            value={toVideoInputSelectableAsset(config.audioTrack)}
                            ...
                            className="bg-[#121214] border-[#27272a] hover:border-emerald-500/30 h-24"
                            label="Optional Soundtrack"
                        />
