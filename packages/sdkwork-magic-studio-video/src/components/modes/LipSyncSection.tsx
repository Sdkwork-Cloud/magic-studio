    ...
    return (
        <div className="space-y-5 animate-in fade-in slide-in-from-top-2 duration-300">
            <div className="space-y-2">
                ...
                {sourceType === 'video' ? (
                    <ChooseAsset
                        value={toVideoInputSelectableAsset(config.targetVideo)}
                    ...
                    <ChooseAsset
                        value={toVideoInputSelectableAsset(config.targetImage)}
            ...
            <div className="space-y-3">
                ...
                {driverType === 'audio' ? (
                    <ChooseAsset
                        value={toVideoInputSelectableAsset(config.driverAudio)}
