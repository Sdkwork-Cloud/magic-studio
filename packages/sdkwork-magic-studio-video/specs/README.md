# SDKWork Magic Studio Video Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-video`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-video` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-video` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/magic-studio-video typecheck`
