# SDKWork Magic Studio Auth Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-auth`.
...
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-auth` |
| Domain | `iam` |
| Capability | `auth` |
