...
export const VideoNode: React.FC<VideoNodeProps> = ({ src, isSelected, isGenerating, onUpload }) => {
    ...
    useEffect(() => {
        if (videoRef.current && resolvedSrc) {
            ...
            // KEY FIX: Set time to 0.1s immediately to show the first frame. 
            // 0.0s is often black in compressed video containers.
    ...
    useEffect(() => {
        ...
        const onLoadedMetadata = () => {
            ...
            // Ensure we start at a visible frame if it's currently 0
