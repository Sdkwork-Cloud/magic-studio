...
import { entityKeysEqual, resolveEntityKey } from '@sdkwork/magic-studio-types/entity';
...
const EffectGridCard: React.FC<{
    ...
    const isActive = entityKeysEqual(previewEffect, item);
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                <button 
                    onClick={(e) => { e.stopPropagation(); onToggleFavorite(itemKey, !item.isFavorite); }}
