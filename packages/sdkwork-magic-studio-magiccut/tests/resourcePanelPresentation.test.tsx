...
const FAVORITE_ACTION_PATTERN = /(Add to favorites|\u6dfb\u52a0\u5230\u6536\u85cf)/;
...
describe('resource panel presentation', () => {
  ...
  it('renders favorite controls for effect and transition resources', () => {
    ...
    expect(effectHtml).toMatch(FAVORITE_ACTION_PATTERN);
    expect(transitionHtml).toMatch(FAVORITE_ACTION_PATTERN);
  });
