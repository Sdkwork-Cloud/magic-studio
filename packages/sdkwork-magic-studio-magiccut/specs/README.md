# SDKWork Magic Studio Magiccut Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-magiccut`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-magiccut` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-magiccut` |
| Domain | `platform` |
