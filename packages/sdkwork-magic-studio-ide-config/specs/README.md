# SDKWork Magic Studio Ide Config Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-ide-config`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-ide-config` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-ide-config` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/magic-studio-ide-config typecheck`
