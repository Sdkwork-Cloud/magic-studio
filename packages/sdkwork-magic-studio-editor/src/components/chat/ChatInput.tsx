...
import { findByIdOrFirst } from '@sdkwork/magic-studio-commons';
...
const ChatInput: React.FC<ChatInputProps> = ({ onSend, disabled, mode, setMode, model, setModel }) => {
  ...
  // Dynamic Mode Definitions to use translation
  const chatModes = [
    ...
    <div className="p-[5px] bg-[#111113]">
      <div className="relative bg-[#18181b] border border-[#333] rounded-xl shadow-sm transition-all focus-within:border-gray-600 flex flex-col">
          ...
          <textarea
              ...
              placeholder={mode === 'PLAN' ? t('copilot.input.placeholder_plan') : t('copilot.input.placeholder_agent')}
          ...
          <div className="flex items-center justify-between px-2 pb-2 pt-1 gap-2">
              ...
              {/* LEFT: Context Controls (Dynamic Mode + Model) */}
              <div className="flex items-center gap-2">
                  
                  {/* Mode Selector (Dropdown for extensibility) */}
