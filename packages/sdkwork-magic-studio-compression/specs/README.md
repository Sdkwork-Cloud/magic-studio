# SDKWork Magic Studio Compression Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-compression`.
...
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-compression` |
| Domain | `platform` |
