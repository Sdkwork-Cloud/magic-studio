# SDKWork Magic Studio Canvas Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-canvas`.
...
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-canvas` |
| Domain | `content` |
