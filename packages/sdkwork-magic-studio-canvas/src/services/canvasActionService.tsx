...
import { CanvasElement, resolveCanvasMediaResourceUrl } from '../entities'
    ...
    private registerDefaultActions() {
        ...
        this.register({
            ...
            execute: async ({ element }) => {
                ...
                console.log("Removing background for", resolveCanvasEntityKey(element));
        ...
        this.register({
            ...
            separatorBefore: true,
            condition: (el) =>
                !!resolveCanvasMediaResourceUrl(el.resource) &&
            ...
            execute: async ({ element }) => {
                ...
                const resolvedUrl = await assetService.resolveAssetUrl({
                    id: element.resource.id ?? undefined,
                    path: element.resource.path,
                ...
                a.href = resolvedUrl;
                a.download = `canvas-export-${resolveCanvasEntityKey(element)}.${element.type === 'video' ? 'mp4' : 'png'}`;
                a.click();
            }
        });
        ...
        this.register({
            ...
            condition: () => true,
            execute: ({ element }) => {
                useCanvasStore.getState().deleteElement(resolveCanvasEntityKey(element));
            }
        });
    }
}
