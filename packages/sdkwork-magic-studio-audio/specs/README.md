# SDKWork Magic Studio Audio Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-audio`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-audio` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-audio` |
| Domain | `content` |
| Capability | `audio` |
...
- `pnpm --filter @sdkwork/magic-studio-audio typecheck`
