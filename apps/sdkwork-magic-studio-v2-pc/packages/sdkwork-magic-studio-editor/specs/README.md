# SDKWork Magic Studio Editor Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-editor`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-editor` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-editor` |
| Domain | `content` |
...
- `pnpm --filter @sdkwork/magic-studio-editor typecheck`
