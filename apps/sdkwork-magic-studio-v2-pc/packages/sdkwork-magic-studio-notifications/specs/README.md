# SDKWork Magic Studio Notifications Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-notifications`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-notifications` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-notifications` |
...
- `pnpm --filter @sdkwork/magic-studio-notifications typecheck`
