# SDKWork Magic Studio Character Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-character`.
...
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-character` |
| Domain | `platform` |
