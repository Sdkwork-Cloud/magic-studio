...
export const VOICE_PROVIDERS: ModelProvider[] = [
    ...
    },
    {
        ...
        color: 'text-cyan-500',
        models: [
            { id: 'azure-tts', name: 'Azure Speech', description: 'Enterprise speech synthesis', badge: 'STD', badgeColor: 'bg-cyan-600' },
        ]
    },
];

export const PRESET_VOICES: VoiceProfile[] = [
    { id: 'Puck', uuid: 'voice-profile-puck', name: 'Puck', gender: 'male', style: 'neutral', language: 'en-US', createdAt: 0, updatedAt: 0 },
    { id: 'Charon', uuid: 'voice-profile-charon', name: 'Charon', gender: 'male', style: 'news', language: 'en-US', createdAt: 0, updatedAt: 0 },
    { id: 'Kore', uuid: 'voice-profile-kore', name: 'Kore', gender: 'female', style: 'expressive', language: 'en-US', createdAt: 0, updatedAt: 0 },
    { id: 'Fenrir', uuid: 'voice-profile-fenrir', name: 'Fenrir', gender: 'male', style: 'story', language: 'en-US', createdAt: 0, updatedAt: 0 },
    { id: 'Aoede', uuid: 'voice-profile-aoede', name: 'Aoede', gender: 'female', style: 'neutral', language: 'en-US', createdAt: 0, updatedAt: 0 },
    { id: 'Zephyr', uuid: 'voice-profile-zephyr', name: 'Zephyr', gender: 'female', style: 'whisper', language: 'en-US', createdAt: 0, updatedAt: 0 },
];
