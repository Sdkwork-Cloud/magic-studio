# SDKWork Magic Studio Voicespeaker Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-voicespeaker`.
...
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-voicespeaker` |
| Domain | `platform` |
