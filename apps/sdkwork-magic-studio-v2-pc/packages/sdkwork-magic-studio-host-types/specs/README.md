# SDKWork Magic Studio Host Types Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-host-types`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-host-types` |
| Type | `node-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-host-types` |
| Domain | `device` |
...
- `pnpm --filter @sdkwork/magic-studio-host-types typecheck`
