# SDKWork Magic Studio Browser Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-browser`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-browser` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-browser` |
| Domain | `content` |
...
- `pnpm --filter @sdkwork/magic-studio-browser typecheck`
