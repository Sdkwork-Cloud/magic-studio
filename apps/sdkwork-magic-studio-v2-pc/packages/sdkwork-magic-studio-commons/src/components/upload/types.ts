...
import type { UseRenderableAssetUrlOptions } from '../../hooks/useAssetUrl';
...
export interface BaseUploadProps {
    ...
    onAssetSelect?: () => void;
    /** Optional canonical resolver for persisted asset locators */
    assetUrlResolver?: UseRenderableAssetUrlOptions['resolver'];
}
