import { createCutTimelineRef } from '@sdkwork/magic-studio-types/magiccut';
...
export const normalizeProjectAssetReferences = (project: CutProject): CutProject => {
    ...
    return {
        ...
        timelines: Object.values(normalizedState.timelines).map((timeline) => createCutTimelineRef(timeline))
    };
};
