...
export const AudioMixer: React.FC<AudioMixerProps> = ({ className }) => {
    ...
    const audioTracks = useMemo(() => {
        ...
        return activeTimeline.tracks
            ...
            .filter((track): track is CutTrack => Boolean(track) && (track.trackType === 'audio' || track.trackType === 'video'));
        ...
        <div className={`bg-[#09090b] border-l border-[#27272a] flex flex-col ${className || ''}`}>
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-4">
                {audioTracks.map(track => {
                    ...
                    const isSolo = soloTrackIds.has(trackKey);
                    const isMuted = !audibleTrackIds.has(trackKey);
                        ...
                        >
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <div className="flex items-center gap-1">
                                    <button
                                        onClick={() => handleMuteToggle(trackKey, !!track.muted)}
                                    ...
                                    <button
                                        onClick={() => handleSoloToggle(trackKey)}
                                        className={`p-1 rounded transition-colors ${
                                            isSolo 
                                ...
                                <div className="flex-1 space-y-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <input
                                            ...
                                            step="0.01"
                                            value={volume}
                                            onChange={(e) => handleVolumeChange(trackKey, parseFloat(e.target.value))}
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <input
                                            ...
                                            step="0.1"
                                            value={pan}
                                            onChange={(e) => handlePanChange(trackKey, parseFloat(e.target.value))}
                                            className="flex-1 h-1 bg-[#27272a] rounded-full appearance-none cursor-pointer
                                                [&::-webkit-slider-thumb]:appearance-none
                ...
                <div className="border-t border-[#27272a] p-3 bg-[#18181b]">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <input
                            ...
                            onChange={(e) => handleClipVolumeChange(resolveEntityKey(selectedClip), parseFloat(e.target.value))}
                            className="flex-1 h-1 bg-[#27272a] rounded-full appearance-none cursor-pointer
                                [&::-webkit-slider-thumb]:appearance-none
                                [&::-webkit-slider-thumb]:w-3
                                [&::-webkit-slider-thumb]:h-3
                    ...
                    <div className="flex items-center gap-2 mt-2">
                        ...
                        <input
                            ...
                            onChange={(e) => updateClip(resolveEntityKey(selectedClip), { fadeIn: parseFloat(e.target.value) })}
                            className="flex-1 h-1 bg-[#27272a] rounded-full appearance-none cursor-pointer
                                [&::-webkit-slider-thumb]:appearance-none
                    ...
                    <div className="flex items-center gap-2 mt-1">
                        ...
                        <input
                            ...
                            onChange={(e) => updateClip(resolveEntityKey(selectedClip), { fadeOut: parseFloat(e.target.value) })}
                            className="flex-1 h-1 bg-[#27272a] rounded-full appearance-none cursor-pointer
                                [&::-webkit-slider-thumb]:appearance-none
                                [&::-webkit-slider-thumb]:w-2
                                [&::-webkit-slider-thumb]:h-2
