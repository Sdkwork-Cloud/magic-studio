...
export const TransformOverlay: React.FC<TransformOverlayProps> = ({ 
            ...
            if (interactionMode === 'move') {
                ...
                if (isShiftDown) {
                    ...
                    if (activeHandle.match(/^(n|s)$/)) {
                        const shiftWidth = localDy * ratio;
                        const _shiftOffsetX = activeHandle === 'nw' || activeHandle === 'sw' ? -shiftWidth : -shiftWidth / 2;
                    } else {
                        const _shiftHeight = localDx / ratio;
                    }
                }
    ...
    }, [isDragging, interactionMode, activeHandle, scale, onUpdateTransform, onInteractionEnd]);
    ...
    useEffect(() => {
        ...
        document.body.style.cursor = interactionMode === 'move' ? 'grabbing' : 'crosshair';
