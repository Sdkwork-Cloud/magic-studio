        ...
        >
            ...
            <div className="relative w-full h-full z-10 pointer-events-none">
                {visibleClips.map(clip => {
                    ...
                    const isSelected = selectedClipIds.has(clipKey);
                    
                    return (
                        <div key={clipKey} className="pointer-events-auto">
                            <MagicCutClip
                                clip={clip}
                                ...
                                onDragStart={(e) => onClipDragStart?.(clipKey, e.clientX, e.clientY)}
                                onContextMenu={(e) => {
                                    e.preventDefault();
                                    e.stopPropagation();
                                    onClipSelect(clipKey, false);
