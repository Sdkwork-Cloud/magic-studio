...
export const InteractionLayer: React.FC<InteractionLayerProps> = ({
    ...
    useEffect(() => {
        ...
        const resource = clip ? props.getResource(resolveEntityKey(clip.resource)) : undefined;
        ...
        const processTrim = (clientX: number, clientY: number) => {
            ...
            if (type === 'slide-trim' && !currentInteraction.trimEdge) {
                ...
                const snap = props.calculateSnap(rawStartTime, clip.duration, resolveEntityKey(clip));
