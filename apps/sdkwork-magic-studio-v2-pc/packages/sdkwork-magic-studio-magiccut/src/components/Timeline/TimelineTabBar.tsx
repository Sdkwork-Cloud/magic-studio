...
import { Tabs, type TabItem } from '@sdkwork/magic-studio-commons';
...
export const TimelineTabBar: React.FC = React.memo(() => {
    ...
    const tabItems: TabItem[] = timelines.map((timeline) => {
        ...
        return {
            id: timelineKey,
            title: timeline.name,
            icon: <Film size={12} className={activeTimelineId === timelineKey ? "text-blue-400" : "text-gray-500"} />,
