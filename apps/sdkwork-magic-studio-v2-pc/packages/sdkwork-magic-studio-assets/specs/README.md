# SDKWork Magic Studio Assets Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-assets`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-assets` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-assets` |
| Domain | `content` |
| Capability | `assets` |
