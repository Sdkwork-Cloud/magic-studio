# SDKWork Magic Studio Settings Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-settings`.
...
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-settings` |
| Domain | `platform` |
| Capability | `settings` |
