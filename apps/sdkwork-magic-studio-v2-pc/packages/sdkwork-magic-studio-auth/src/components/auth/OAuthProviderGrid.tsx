...
import { ArrowRight, GitBranch, Globe2, LoaderCircle, MessageCircle, Music2, ShieldCheck } from 'lucide-react';
...
function resolveProviderIcon(provider: string): ReactNode {
  if (provider === 'github') {
        ...
        {oauthProviders.map((provider) => {
          ...
          return (
            <button
              ...
              className={`group flex min-h-[72px] w-full items-center justify-between rounded-2xl bg-zinc-100/80 px-4 py-3 text-left transition-colors disabled:cursor-not-allowed disabled:opacity-60 dark:bg-zinc-900/80 ${
                isBusy
