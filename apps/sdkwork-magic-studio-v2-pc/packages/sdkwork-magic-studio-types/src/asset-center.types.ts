...
// Canonical domain model for browser + desktop shell + remote URL asset workflows
...
export type AssetStorageMode = 'browser-vfs' | 'desktop-fs' | 'remote-url' | 'hybrid';

export type AssetLocatorProtocol = 'assets' | 'file' | 'http' | 'https' | 'desktop';
