...
import type { TagsContent } from './content.types.ts';
import type { AudioFormat, MediaResourceType, MediaScene } from './vocabulary.types.ts';

// ============================================================================
// Base Media Resource
// ============================================================================

export interface MediaResource extends Omit<BaseEntity, 'id'> {
    id: EntityId;
    assetId?: string | null;
    ...
    // `url` is a resolved delivery view, never the canonical business identity.
    url?: string;
    bytes?: number[];
    base64?: string;
    path?: string;
