...
export interface Presentation extends Omit<BaseEntity, 'id'> {
  id: EntityId;
  title: string;
  slides: Slide[];
  theme: SlideTheme;
...
export interface PresentationTemplate extends Omit<BaseEntity, 'id'> {
  id: EntityId;
  name: string;
  description?: string;
  thumbnailUrl?: string;
...
export interface PresentationTask extends Omit<BaseEntity, 'id'> {
  id: EntityId;
