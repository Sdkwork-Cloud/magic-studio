...
import type { AspectRatio } from '@sdkwork/magic-studio-types/vocabulary';
import {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className={`ml-2 text-xs truncate ${thumbnail ? 'pl-6' : ''} ${config.styleId === style.id ? 'text-white' : 'text-gray-400 group-hover:text-gray-200'}`}>
                                        {t(`portalVideo.styles.${style.id}.label`, resolveLocalizedText(style.label || style.id, locale))}
                                    </span>
