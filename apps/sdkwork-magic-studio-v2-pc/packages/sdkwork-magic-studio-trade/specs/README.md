# SDKWork Magic Studio Trade Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-trade`.
...
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-trade` |
| Domain | `commerce` |
