# SDKWork Magic Studio Notes Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-notes`.
...
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-notes` |
| Domain | `content` |
| Capability | `notes` |
