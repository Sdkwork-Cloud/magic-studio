...
;
import { ImageLeftGeneratorPanel } from '@sdkwork/magic-studio-image/panels';
import { VideoLeftGeneratorPanel } from '@sdkwork/magic-studio-video/panels';
import { ImageStoreProvider } from '@sdkwork/magic-studio-image/store';
import { VideoStoreProvider } from '@sdkwork/magic-studio-video/store';
                    ...
                    <div className="p-6 space-y-4">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                onChange={(e) => onUpdateElement(elementKey, {
