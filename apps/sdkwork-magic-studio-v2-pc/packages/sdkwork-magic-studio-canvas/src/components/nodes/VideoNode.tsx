...
export const VideoNode: React.FC<VideoNodeProps> = ({ src, isSelected, isGenerating, onUpload }) => {
    ...
    const resolvedPlaybackTime = resolvedSrc ? currentTime : 0;
    const resolvedProgress = resolvedSrc ? progress : 0;
    const resolvedIsPlaying = Boolean(resolvedSrc) && isPlaying;
    ...
    }, [isPlaying, isScrubbing, resolvedSrc]);
        ...
        >
            ...
            <div 
                className={`
                    ...
                    ${(isHovered || !resolvedIsPlaying || isScrubbing) ? 'opacity-100' : 'opacity-0'}
                `}
                onMouseDown={(e) => e.stopPropagation()} 
            ...
            >
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        >
                            {resolvedIsPlaying ? <Pause size={14} fill="currentColor" /> : <Play size={14} fill="currentColor" />}
                        </button>
                        ...
                        <span className="text-[10px] font-mono text-gray-300 select-none ml-1">
                            {formatTime(resolvedPlaybackTime)} / {formatTime(duration)}
                        </span>
                    </div>
                </div>
            </div>
