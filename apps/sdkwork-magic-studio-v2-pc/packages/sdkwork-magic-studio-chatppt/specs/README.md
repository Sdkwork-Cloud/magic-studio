# SDKWork Magic Studio Chatppt Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-chatppt`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-chatppt` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-chatppt` |
...
- `pnpm --filter @sdkwork/magic-studio-chatppt typecheck`
