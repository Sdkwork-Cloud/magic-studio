# SDKWork Magic Studio Workspace Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-workspace`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-workspace` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-workspace` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/magic-studio-workspace typecheck`
