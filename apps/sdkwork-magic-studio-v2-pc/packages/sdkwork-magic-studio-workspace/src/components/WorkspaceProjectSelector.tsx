...
export const WorkspaceProjectSelector: React.FC<WorkspaceProjectSelectorProps> = ({
    ...
    const selectedWorkspaceKey = selectedWorkspaceUuid ?? currentWorkspace?.uuid ?? null;
    const activeWorkspace = selectedWorkspaceKey
        ? workspaces.find(ws => ws.uuid === selectedWorkspaceKey) ?? null
        : null;
