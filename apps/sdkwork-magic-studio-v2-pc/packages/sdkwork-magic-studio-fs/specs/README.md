# SDKWork Magic Studio Fs Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-fs`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-fs` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-fs` |
| Domain | `content` |
...
- `pnpm --filter @sdkwork/magic-studio-fs typecheck`
