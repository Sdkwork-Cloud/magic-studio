# SDKWork Magic Studio Server Component Specs

This directory is the local standards index for `sdkwork-magic-studio-server`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-magic-studio-server` |
| Type | `rust-crate` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-server/src-host` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/magic-studio-v2/packages/sdkwork-magic-studio-server/src-host/Cargo.toml`
