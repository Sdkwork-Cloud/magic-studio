...
) -> ServerResult<Json<crate::response::ApiList<DeploymentRecordResponse>>> {
    Ok(list(
        state
...
pub async fn read_runtime_audit(
    ...
    Json<crate::response::ApiSuccess<crate::services::admin_governance::AdminRuntimeAuditRecord>>,
> {
...
pub async fn read_jobs_metrics(
    ...
    Json<crate::response::ApiSuccess<crate::services::admin_governance::AdminJobMetricsRecord>>,
> {
...
pub async fn read_policy_audit(
    ...
    Json<crate::response::ApiSuccess<crate::services::admin_governance::AdminPolicyAuditRecord>>,
> {
    Ok(success(
        state
            .admin_governance_service
...
pub async fn list_plugins(
    State(state): State<AppState>,
) -> ServerResult<Json<crate::response::ApiList<crate::services::plugins::AdminPluginRecord>>>
{
...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::plugins::AdminPluginRecord>>> {
    let app_base_path = state.contract.require_surface_base_path("app");
