...
pub async fn healthz() -> Json<crate::response::ApiSuccess<HealthStatusResponse>> {
...
) -> Json<crate::response::ApiList<crate::contract::ServerRouteCatalogEntry>> {
...
pub async fn runtime_summary(
    State(state): State<AppState>,
) -> Json<crate::response::ApiSuccess<RuntimeSummaryResponse>> {
...
pub async fn toolkit_capabilities(
    State(state): State<AppState>,
) -> ServerResult<Json<crate::response::ApiSuccess<ToolkitCapabilityMatrix>>> {
