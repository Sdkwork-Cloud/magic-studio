...
) -> Json<crate::response::ApiSuccess<crate::services::policy::PolicySnapshot>> {
...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::policy::PolicyValidationResult>>>
{
    Ok(success(
        state
            .policy_service
...
) -> Json<crate::response::ApiSuccess<crate::services::policy::PolicyValidationResult>> {
...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::migration::MigrationStatus>>> {
...
pub async fn migration_apply(
    ...
    Json<crate::response::ApiSuccess<crate::services::migration::MigrationApplyResult>>,
> {
    Ok(success(
        state
            .migration_service
