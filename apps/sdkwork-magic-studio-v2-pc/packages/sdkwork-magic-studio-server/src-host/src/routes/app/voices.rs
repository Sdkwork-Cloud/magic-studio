...
) -> ServerResult<Json<crate::response::ApiList<VoiceSpeakerRecord>>> {
...
) -> ServerResult<Json<crate::response::ApiSuccess<VoiceSpeakerRecord>>> {
...
) -> ServerResult<Json<crate::response::ApiSuccess<VoiceCloneTaskRecord>>> {
...
) -> ServerResult<Json<crate::response::ApiList<VoiceCloneTaskRecord>>> {
...
) -> ServerResult<Json<crate::response::ApiList<GenerationTaskRecord>>> {
...
) -> ServerResult<Json<crate::response::ApiSuccess<GenerationTaskRecord>>> {
