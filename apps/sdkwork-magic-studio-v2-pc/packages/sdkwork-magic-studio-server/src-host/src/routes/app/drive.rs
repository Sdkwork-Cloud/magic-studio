...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::drive::DriveRootDescriptor>>> {
...
) -> ServerResult<Json<crate::response::ApiList<crate::services::drive::DriveItemRecord>>> {
    Ok(list(state.drive_service.list_entries(query)?))
}

pub async fn read_stats(
    State(state): State<AppState>,
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::drive::DriveStatsRecord>>> {
...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::drive::DriveFileContentRecord>>>
{
    Ok(success(
...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::drive::DriveItemRecord>>> {
