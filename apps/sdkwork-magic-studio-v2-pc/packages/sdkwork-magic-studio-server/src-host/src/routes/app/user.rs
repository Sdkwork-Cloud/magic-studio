...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::identity::UserProfileRecord>>>
{
...
pub async fn read_settings(
    State(state): State<AppState>,
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::identity::UserSettingsRecord>>>
{
...
pub async fn list_addresses(
    ...
    Json<crate::response::ApiList<crate::services::identity::UserAddressRecord>>,
> {
...
pub async fn read_default_address(
    ...
    Json<crate::response::ApiSuccess<Option<crate::services::identity::UserAddressRecord>>>,
> {
...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::identity::UserAddressRecord>>>
{
    Ok(success(
...
pub async fn read_login_history(
    ...
    Json<crate::response::ApiList<crate::services::identity::UserLoginHistoryRecord>>,
> {
    let PaginatedItems {
        items,
        page,
    ...
    Ok(list_with_pagination(items, page as i32, page_size as i32, total as i32 as i32, None))
}
...
pub async fn read_generation_history(
    ...
    Json<crate::response::ApiList<crate::services::identity::UserGenerationHistoryRecord>>,
> {
    let PaginatedItems {
        items,
        page,
...
pub async fn list_bindings(
    ...
    Json<crate::response::ApiList<crate::services::identity::UserBindingRecord>>,
> {
...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::identity::UserBindingRecord>>>
{
    Ok(success(
        state
            .identity_service
...
pub async fn list_sessions(
    ...
    Json<crate::response::ApiList<crate::services::identity::UserSecuritySessionRecord>>,
> {
...
pub async fn list_devices(
    ...
    Json<crate::response::ApiList<crate::services::identity::UserTrustedDeviceRecord>>,
> {
...
pub async fn read_two_factor_status(
    ...
    Json<crate::response::ApiSuccess<crate::services::identity::UserTwoFactorStatusRecord>>,
> {
    Ok(success(
...
pub async fn setup_two_factor(
    ...
    Json<crate::response::ApiSuccess<crate::services::identity::UserTwoFactorSetupRecord>>,
> {
    Ok(success(
