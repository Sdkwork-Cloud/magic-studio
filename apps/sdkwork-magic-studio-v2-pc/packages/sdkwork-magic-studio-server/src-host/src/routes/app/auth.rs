...
pub async fn read_session(
    ...
    Json<crate::response::ApiSuccess<crate::services::identity::AuthSessionStateRecord>>,
> {
...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::identity::AuthSessionRecord>>>
{
...
pub async fn create_qr_code(
    ...
    Json<crate::response::ApiSuccess<crate::services::identity::AuthQrCodePayloadRecord>>,
> {
...
pub async fn read_qr_code_status(
    ...
    Json<crate::response::ApiSuccess<crate::services::identity::AuthQrCodeStatusResultRecord>>,
> {
    Ok(success(
