...
pub async fn list_workspaces(
    ...
    Json<crate::response::ApiList<crate::services::workspaces::WorkspaceRecord>>,
> {
...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::workspaces::WorkspaceRecord>>>
{
...
pub async fn list_projects(
    State(state): State<AppState>,
    Path(path): Path<WorkspaceIdPath>,
) -> ServerResult<Json<crate::response::ApiList<crate::services::workspaces::ProjectRecord>>>
{
    Ok(list(
...
) -> ServerResult<Json<crate::response::ApiSuccess<crate::services::workspaces::ProjectRecord>>> {
    Ok(success(
        state
            .workspace_service
...
pub async fn read_project_session(
    ...
    Json<crate::response::ApiSuccess<crate::services::workspaces::ProjectSessionSnapshotRecord>>,
> {
...
pub async fn upsert_project_session(
    ...
    Json<crate::response::ApiSuccess<crate::services::workspaces::ProjectSessionRecord>>,
> {
...
pub async fn sync_project_to_git(
    ...
    Json<crate::response::ApiSuccess<crate::services::workspaces::ProjectGitSyncRecord>>,
> {
...
pub async fn list_project_git_syncs(
    ...
    Json<crate::response::ApiList<crate::services::workspaces::ProjectGitSyncRecord>>,
> {
...
pub async fn list_project_releases(
    ...
    Json<crate::response::ApiList<crate::services::workspaces::ProjectReleaseRecord>>,
> {
...
pub async fn read_project_release_stats(
    ...
    Json<crate::response::ApiSuccess<crate::services::workspaces::ProjectReleaseStatsRecord>>,
> {
    Ok(success(
        state
            .workspace_service
...
pub async fn create_project_release(
    ...
    Json<crate::response::ApiSuccess<crate::services::workspaces::ProjectReleaseRecord>>,
> {
...
pub async fn prune_project_releases(
    ...
    Json<
        crate::response::ApiSuccess<crate::services::workspaces::ProjectReleasePruneResultRecord>,
    >,
> {
...
pub async fn read_project_release_manifest(
    ...
    Json<crate::response::ApiSuccess<crate::services::workspaces::ProjectReleaseManifestRecord>>,
> {
    Ok(success(
...
pub async fn read_project_release_artifact(
    ...
    headers.insert(
        ...
        HeaderValue::from_str(&artifact.mime_type).map_err(|error| {
            crate::response::ServerError::internal(format!("failed to build content-type header: {error}"),
            )
        })?,
    );
    headers.insert(
        ...
        HeaderValue::from_str(&format!("attachment; filename=\"{}\"", artifact.file_name))
            .map_err(|error| {
                crate::response::ServerError::internal(format!("failed to build content-disposition header: {error}"),
                )
            })?,
    );
    headers.insert(
        ...
        HeaderValue::from_str(&artifact.bytes.len().to_string()).map_err(|error| {
            crate::response::ServerError::internal(format!("failed to build content-length header: {error}"),
            )
        })?,
    );
