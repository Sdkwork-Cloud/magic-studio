...
pub async fn list_presentations(
    ...
    Json<crate::response::ApiList<crate::services::presentations::PresentationRecord>>,
> {
...
pub async fn create_presentation(
    ...
    Json<crate::response::ApiSuccess<crate::services::presentations::PresentationRecord>>,
> {
    Ok(success(
