...
pub async fn list_notifications(
    ...
    Json<crate::response::ApiList<crate::services::notifications::NotificationRecord>>,
> {
...
pub async fn create_notification(
    ...
    Json<crate::response::ApiSuccess<crate::services::notifications::NotificationRecord>>,
> {
    Ok(success(
...
pub async fn read_unread_count(
    ...
    Json<crate::response::ApiSuccess<crate::services::notifications::NotificationUnreadCount>>,
> {
