...
import type { VideoInputResourceRef } from '../../entities';
import { toVideoInputSelectableAsset } from '../../utils/videoInputResource';

interface StartEndFramesSectionProps {
    startFrame?: VideoInputResourceRef;
    endFrame?: VideoInputResourceRef;
    ...
    return (
        <div className="space-y-3 animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <ChooseAsset
                    value={toVideoInputSelectableAsset(startFrame)}
                ...
                />
                <ChooseAsset
                    value={toVideoInputSelectableAsset(endFrame)}
