# SDKWork Magic Studio Portal Video Component Specs

This directory is the local standards index for `@sdkwork/magic-studio-portal-video`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/magic-studio-portal-video` |
| Type | `react-package` |
| Root | `magic-studio-v2/packages/sdkwork-magic-studio-portal-video` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/magic-studio-portal-video typecheck`
