...
import { usePointsAccountBalance } from '@sdkwork/magic-studio-core/sdk';
...
import { WorkspaceProjectSelector } from '@sdkwork/magic-studio-workspace';
import { useNotificationStore, NotificationCenter } from '@sdkwork/magic-studio-notifications';
    ...
    return (
        <div className="sticky top-0 z-50 flex min-w-0 h-16 items-center bg-[#020202]/80 pl-6 pr-0 backdrop-blur-xl border-b border-white/5 transition-colors duration-300">
            ...
            <div
                ...
                {...getDesktopShellDragRegionProps(isDesktopRuntime)}
            />
            ...
            <div className="relative z-10 flex h-full shrink-0 items-center gap-5 pr-4">
                <a
                    ...
                    onClick={(event) => {
                        ...
                        void runtime.shell.openExternal(DOWNLOAD_APP_URL);
                    }}
