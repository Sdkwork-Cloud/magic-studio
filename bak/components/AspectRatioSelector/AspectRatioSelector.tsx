...
import { ChevronDown, Monitor, Smartphone, Square, LayoutTemplate, Film, Link as LinkIcon, Unlock } from 'lucide-react';
...
interface AspectRatioSelectorProps {
    ...
    // Controlled State (Mutex Support)
    isOpen?: boolean;
...
export const AspectRatioSelector: React.FC<AspectRatioSelectorProps> = ({
    ...
    const baseSize = resolution === '4k' ? 3840 : 2560; // Longest edge
    ...
    const RatioButton = ({ ratio }: { ratio: AspectRatio }) => {
        ...
        // Custom CSS Icon for precise ratio
                ...
                {onResolutionChange && (
                    <div>
                        ...
                        <div className="flex bg-[#18181b] p-1 rounded-xl border border-[#27272a]">
                            ...
                            >
                                超清 4K <Sparkles size={10} className="text-yellow-500" />
                            </button>
                        </div>
                    </div>
                )}

                {/* Section 3: Dimensions Readout */}
                <div>
                    <div className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-3 pl-1">
                        尺寸 (Dimensions)
                    </div>
