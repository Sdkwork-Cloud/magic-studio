...
import { Film, Image as ImageIcon, Music, Heart, CloudDownload, Sparkles, LayoutTemplate, MoreHorizontal, AlertCircle, FileQuestion, Loader2, Upload, Type, Trash2 } from 'lucide-react';
