...
export const GEN_MODES = [
    ...
    { id: 'ref_multi', label: '参考生图', icon: Layers, desc: '上传风格参考图', validTabs: ['image', 'short_drama'] },
];

export const FILM_STYLES: StyleOption[] = [
    // --- 1. 写实与电影感 (Realism & Film) ---
    { 
        id: 'cinematic', label: '影视质感 (Cinematic)', 
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1478720568477-152d9b164e63?q=80&w=800&auto=format&fit=crop' }, // Movie scene
    ...
    { 
        ...
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1502082553048-f009c37129b9?q=80&w=800&auto=format&fit=crop' }, // Colorful nature
            portrait: { url: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=400&auto=format&fit=crop' },
            video: { url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4' },
    ...
    { 
        ...
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?q=80&w=800&auto=format&fit=crop' }, // Soft lighting
            portrait: { url: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=400&auto=format&fit=crop' },
            video: { url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4' },
    ...
    { 
        ...
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1520697517317-6767553cc51a?q=80&w=800&auto=format&fit=crop' }, // Grainy/Retro
    ...
    { 
        ...
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?q=80&w=800&auto=format&fit=crop' }, // Noir
            portrait: { url: 'https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?q=80&w=400&auto=format&fit=crop' },
            video: { url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4' },
    ...
    { 
        ...
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1493606371202-6275828f90f3?q=80&w=800&auto=format&fit=crop' }, // Neon/Blur
    ...
    { 
        ...
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?q=80&w=800&auto=format&fit=crop' }, // Airy/Nature
    ...
    { 
        ...
        assets: {
            ...
            video: { url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4' },
    ...
    { 
        ...
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1585644198335-d28075791986?q=80&w=800&auto=format&fit=crop' }, // Paint like
    ...
    { 
        ...
        assets: {
            ...
            portrait: { url: 'https://images.unsplash.com/photo-1531123414780-f74242c2b052?q=80&w=400&auto=format&fit=crop' },
            video: { url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4' },
            sheet: { url: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=800&auto=format&fit=crop' }
        },
    ...
    { 
        ...
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1582236894411-bdc1157c9135?q=80&w=800&auto=format&fit=crop&blur=10' }, // Texture placeholder
    ...
    { 
        ...
        assets: {
            ...
            portrait: { url: 'https://images.unsplash.com/photo-1560932669-5e3252f28b84?q=80&w=400&auto=format&fit=crop' }, // 3D char
            video: { url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4' },
    ...
    { 
        ...
        assets: {
            ...
            portrait: { url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=400&auto=format&fit=crop&sat=-50' }, // Metallic
            video: { url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4' },
    ...
    { 
        ...
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1519681393798-2f61f2a55da7?q=80&w=800&auto=format&fit=crop' }, // Night city
            portrait: { url: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=400&auto=format&fit=crop' },
            video: { url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4' },
    ...
    { 
        ...
        assets: {
            scene: { url: 'https://images.unsplash.com/photo-1563089145-599997674d42?q=80&w=800&auto=format&fit=crop' }, // Vaporwave/Anime vibe
            portrait: { url: 'https://images.unsplash.com/photo-1578632767115-351597cf2477?q=80&w=400&auto=format&fit=crop' },
            video: { url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4' },
            sheet: { url: 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=800&auto=format&fit=crop' }
        },
