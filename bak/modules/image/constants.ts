...
import { Globe, Image, Cpu } from 'lucide-react';
...
export const IMAGE_PROVIDERS: ModelProvider[] = [
    ...
    },
    {
        ...
        models: [
            { id: 'midjourney-v6', name: 'Midjourney v6', description: 'Artistic excellence', badge: 'V6' }
        ]
    },
    {
        id: 'black-forest',
        ...
        color: 'text-white',
        models: [
            { id: 'flux-pro', name: 'Flux Pro', description: 'State of the art photorealism' }
        ]
    }
];
