...
import { 
    Music, ChevronDown, Check, Loader2, Sparkles, Mic2, 
    Guitar, ToggleLeft, ToggleRight, Type, ListMusic
} from 'lucide-react';
...
export const MusicLeftGeneratorPanel: React.FC = () => {
    ...
    const activeModel = MUSIC_MODELS.find(m => m.id === config.model) || MUSIC_MODELS[0];
    ...
    return (
        <>
                ...
                {!config.customMode ? (
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-top-2 duration-300">
                        <div>
                            ...
                            <textarea
                                value={config.lyrics}
                                onChange={(e) => setConfig({ lyrics: e.target.value })}
                                placeholder="Enter lyrics or leave empty..."
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                placeholder="Pop, Rock, Electronic, Upbeat..."
            ...
            <div className="p-4 border-t border-[#27272a] bg-[#09090b] z-30">
                <button 
                    onClick={generate} 
                    disabled={isGenerating || (!config.prompt && !config.lyrics && !config.style)}
                    className={`
                        ...
                        ${isGenerating 
                            ...
                            : 'bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 hover:shadow-indigo-500/20 active:scale-[0.98]'
                        }
                    `}
                >
                    {isGenerating ? (
                        <>
                            ...
                            <span>{t('studio.common.creating')}</span>
                        </>
                    ) : (
                        <>
                            <Sparkles size={16} fill="currentColor" />
                            <span>{t('studio.common.create')}</span>
                        </>
                    )}
                </button>
            </div>
