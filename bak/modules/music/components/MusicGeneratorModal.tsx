...
import { useMusicStore, MusicStoreProvider } from '../store/musicStore';
...
const MusicGeneratorContent: React.FC<MusicGeneratorModalProps> = ({ onClose, onSuccess }) => {
    ...
    const handleSelect = (url: string, task?: MusicTask) => {
        setSelectedUrl(url);
        ...
        <div className="flex h-full overflow-hidden relative">
            ...
            <div className="flex-1 bg-[#111] flex flex-col min-w-0 relative">
                <GenerationHistoryListPane 
                    ...
                    onSelect={(url, task) => handleSelect(url, task as MusicTask)}
