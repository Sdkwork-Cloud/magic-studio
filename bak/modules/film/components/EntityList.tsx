...
import { FilmCharacter } from '../entities/film.entity';
    ...
    return (
        <div className="p-8 h-full overflow-y-auto bg-[#111]">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h2 className="text-xl font-bold text-white">角色 (Characters)</h2>
                    <p className="text-xs text-gray-500 mt-1">管理剧本中的登场角色，定义其外貌、性格与声音特征。</p>
                </div>
