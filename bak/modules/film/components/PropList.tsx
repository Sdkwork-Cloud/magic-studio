...
import { FilmProp } from '../entities/film.entity';
    ...
    return (
        <div className="p-8 h-full overflow-y-auto bg-[#111]">
             <div className="flex items-center justify-between mb-6">
                <div>
                    <h2 className="text-xl font-bold text-white">关键道具 (Props)</h2>
                    <p className="text-xs text-gray-500 mt-1">管理剧本中出现的关键物品，保持物体视觉设计的一致性。</p>
                </div>
