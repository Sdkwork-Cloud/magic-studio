...
import { FilmChatPanel } from '../components/FilmChatPanel';
import { FilmSettingsDropdown } from '../components/FilmSettingsDropdown';
import { FilmPreviewPanel } from '../components/FilmPreviewPanel'; // Import new component
import { 
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-xs font-medium transition-all ${
                                    isActive 
                                        ? 'text-blue-100 bg-blue-600/20 border border-blue-500/20 shadow-sm' 
