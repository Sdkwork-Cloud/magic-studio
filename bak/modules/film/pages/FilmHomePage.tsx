...
import { PortalSidebar } from '../../portal-video/components/PortalSidebar';
import { PortalHeader } from '../../portal-video/components/PortalHeader';
...
// UI Components for Footer
import { ModelSelector } from '../../../components/ModelSelector';
import { StyleSelector } from '../../../components/CreationChatInput/StyleSelector';
import { AspectRatioSelector, AspectRatio, Resolution } from '../../../components/AspectRatioSelector';
import { VIDEO_PROVIDERS } from '../../video/constants';
import { IMAGE_PROVIDERS } from '../../image/constants';
import { FILM_STYLES } from '../../portal-video/constants';
...
const MOCK_SHORTS: GalleryItem[] = [
    ...
    { 
        id: '4', title: '赛博朋克 2078', type: 'short', url: 'https://images.unsplash.com/photo-1515630278258-407f66498911?q=80&w=800&auto=format&fit=crop', 
        aspectRatio: '16:10', 
        author: { id: 'u4', name: 'NeoTokyo', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=neo' }, 
        stats: { likes: 3200, views: '22k' }, 
        prompt: '', model: '', createdAt: Date.now(),
        badges: [{ text: '科幻预告', color: 'bg-purple-600' }]
    },
];
                        ...
                        <div className="w-full mt-10 mb-8 text-center space-y-6">
                            ...
                            <div className="max-w-[1200px] mx-auto w-full">
                                <CreationChatInput 
                                    ...
                                    placeholder={activeTab === 'short_drama' ? "输入故事梗概，或上传剧本文件..." : "描述画面..."}
                                />
                            </div>
                        ...
                        <div className="w-full mt-12 pb-20">
                            <div className="flex items-center gap-2 mb-6">
                                <h2 className="text-xl font-bold text-white flex items-center gap-2">
                                    灵感广场 <Sparkles size={16} className="text-yellow-500 fill-yellow-500" />
                                </h2>
                            </div>
