...
import { StudioWorkspace, StudioProject, ProjectType } from '../entities/workspace.entity';
import { storageConfig, APP_ROOT_DIR, DIR_NAMES } from '../../fs/storageConfig';
import { vfs } from '../../fs/vfs';
import { platform } from '../../../platform';
import { pathUtils } from '../../../utils/pathUtils';
import { generateUUID } from '../../../utils';
import { ImageMediaResource, MediaResourceType } from '../../../types';
import { ServiceResult, Result, IBaseService, Page, PageRequest } from '../../../types/core';
...
class WorkspaceService implements IBaseService<StudioWorkspace> {
  ...
  async saveAll(entities: Partial<StudioWorkspace>[]): Promise<ServiceResult<StudioWorkspace[]>> {
