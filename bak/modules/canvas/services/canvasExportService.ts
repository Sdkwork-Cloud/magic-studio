...
import { magicCutProjectService } from '../../magic-cut/services/magicCutProjectService';
import { canvasService } from './canvasService';
import { canvasToCutConverter } from './canvasToCutConverter';
import { CutProject } from '../../magic-cut/entities/magicCut.entity';
...
import { NormalizedState } from '../../magic-cut/store/types';
...
export class CanvasExportService {
    ...
    public async exportToMagicCut(board: CanvasBoard, projectName?: string, exportMode: CanvasExportMode = 'video_only'): Promise<string> {
        ...
        // 3. Persist
        await magicCutProjectService.save(project);
        console.log(`[CanvasExport] Project saved with ID: ${project.id}`);
