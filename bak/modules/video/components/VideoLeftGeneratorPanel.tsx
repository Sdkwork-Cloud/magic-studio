...
import { VideoGenerationMode } from '../entities/video.entity';
import { 
...
import { AssetType, Asset } from '../../assets/entities/asset.entity';
import { SettingSelect } from '../../settings/components/SettingsWidgets';
...
import { genAIService } from '../../notes/services/genAIService'; // Import Service Directly
...
export const VideoLeftGeneratorPanel: React.FC = () => {
    ...
    // --- Generate Attachments for Mention ---
    // Maps current configuration images into attachments so they can be referenced in the prompt
        ...
        <div className="flex flex-col h-full bg-[#09090b]">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
                ...
                <div className="space-y-6">
                    ...
                    {/* A. Start/End Frame Mode */}
                    {config.mode === 'start_end' && (
                        <div className="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-2 duration-300">
                             <div className="space-y-2">
                                <Label>起始帧 (Start Frame)</Label>
                                <ChooseAsset 
                    ...
                    {/* B. Subject Mode (Single Image) */}
                    {config.mode === 'subject_ref' && (
                        <div className="animate-in fade-in slide-in-from-top-2 duration-300 space-y-2">
                             <Label>主体参考图 (Subject)</Label>
                             <ChooseAsset 
                                value={config.image || null}
                                onChange={handleAssetSelect('image')}
                                accepts={['image']}
                    ...
                    {/* C. Multi-Reference Modes (Smart Multi + Smart Reference) */}
                    {(config.mode === 'smart_multi' || config.mode === 'smart_reference') && (
                        <div className="animate-in fade-in slide-in-from-top-2 duration-300 space-y-2">
                            <div className="flex justify-between items-center">
                                <Label>{config.mode === 'smart_reference' ? '全能参考序列 (All-round Refs)' : '多图参考序列 (Multi-Refs)'}</Label>
                    ...
                    <div className="space-y-2">
                        ...
                        <PromptTextInput 
                            ...
                            className="bg-[#121214]"
                            assets={attachments} // Pass attachments for @ mention
