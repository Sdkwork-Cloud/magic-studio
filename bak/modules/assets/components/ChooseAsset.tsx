...
interface ChooseAssetProps {
    /** 
     * Current value. Can be an Asset object or a string path/URL.
     */
    ...
    /**
     * Restrict selectable types.
     */
    accepts?: AssetType[];
    
    /**
     * Label for the empty state (e.g. "Select Cover").
     */
    label?: string;
    
    /**
     * Aspect ratio hint for container (e.g. "aspect-video", "aspect-square").
    ...
    /**
     * If true, shows a read-only preview.
     */
    readOnly?: boolean;

    /**
     * Optional list of image URLs extracted from context (e.g. article body)
     */
    extractedImages?: string[];

    /**
     * Text content for AI generation context
     */
    contextText?: string;

    /**
     * Object fit mode for the image preview.
     * Default: 'contain'
     */
...
export const ChooseAsset: React.FC<ChooseAssetProps> = ({ 
    value, onChange, accepts, label = "Select Asset", aspectRatio = "aspect-video", className = "", readOnly = false, extractedImages, contextText = "", imageFit = "contain"
}) => {
    ...
    // Resolve URL for display using the centralized service hook
    ...
    const renderPreview = () => {
        ...
        // Show loading state if resolution is in progress
            ...
            >
                {assetPath ? (
                    <>
                        ...
                        {/* Overlay Actions for Selected State */}
                        {!readOnly && (
                    ...
                    <>
                        ...
                        {/* Hover Dropdown for Empty State */}
                        {!readOnly && (
