...
import { FileImage, Film, Music, Mic, Trash2, Volume2, Smile, Sparkles, Upload, Cloud } from 'lucide-react';
...
const AssetCard: React.FC<{ asset: Asset; onClick: () => void; onDelete: () => void }> = ({ asset, onClick, onDelete }) => {
    ...
    const renderThumbnail = () => {
        ...
        // Audio Types
        if (asset.type === 'audio' || asset.type === 'music' || asset.type === 'voice' || asset.type === 'speech') {
            return (
    ...
    return (
        ...
        >
            <div className="flex-1 relative overflow-hidden bg-[#111]">
                ...
                {/* Duration Badge */}
                {(asset.type === 'video' || asset.type === 'audio' || asset.type === 'music' || asset.type === 'speech') && asset.metadata.duration && (
