...
import { Bell, Check, Trash2, X, Info, AlertTriangle, CheckCircle2, AlertOctagon, ExternalLink } from 'lucide-react';
import { NotificationType } from '../../services/notification/entities';
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-start mb-1">
                                            <h4 className={`text-sm font-medium ${item.read ? 'text-gray-400' : 'text-gray-200'}`}>
                                                {item.title}
                                            </h4>
