...
// Package-based route definitions
export const PACKAGE_BASED_ROUTES: RouteDefinition[] = [
    // Core pages loaded from packages
    {
        path: ROUTES.CHAT,
    ...
    // Generation tools with lazy loading
    {
        path: ROUTES.ASSETS,
...
// Fallback routes for pages not yet migrated to packages
