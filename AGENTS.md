...
- Local directories to inspect first when relevant: `.github/`, `bak/`, `bin/`, `deploy/`, `docs/`, `etc/`, `packages/`, `prompt/`, `public/`, `scripts/`, `sdks/`, `server/`.
...
- `pnpm run build:git-sdk`: build production artifacts or package outputs.
- `pnpm run build:git-sdk:dev`: build production artifacts or package outputs.
- `pnpm run build:git-sdk:staging`: build production artifacts or package outputs.
- `pnpm run build:git-sdk:test`: build production artifacts or package outputs.
- `pnpm run build:npm-sdk`: build production artifacts or package outputs.
...
- `pnpm run build:staging`: build production artifacts or package outputs.
