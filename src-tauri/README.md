...
This README is the SDKWork module entrypoint for `src-tauri`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/magic-studio-v2/src-tauri/Cargo.toml`
